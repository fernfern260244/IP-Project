...
<body>
          ...
          <div x-data="{ open: false }" class="bg-white  dark:bg-white w-64  shadow flex justify-center items-center mr-6 ml-5">
            <div @click="open = !open" class="relative border-b-4 border-transparent py-3" :class="{'border-indigo-700 transform transition duration-300 ': open}" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100">
              <div class="flex justify-center items-center space-x-3 cursor-pointer">
                ...
                <div class="font-semibold  dark:text-white text-gray-900 text-base">
  ...
  <section class="max-w-4xl p-6 mx-auto rounded-md shadow-md bg-slate-800 mt-16 mb-20">
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="grid grid-row-1 gap-6 mt-4 ">
        ...
        <div>
          ...
          <input type="hidden" name="p_id" value="<?php echo $row['product_id']; ?>" class="block w-full px-4 py-2 mt-2  text-white bg-white border border-gray-300 rounded-md   dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
        </div>
        <div>
          <label class=" text-white">ชื่อสินค้า </label>
          <input type="text" name="p_name" value="<?php echo $row['product_name']; ?>" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-gray-300 rounded-md   dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
        </div>

        <div>
          <label class=" text-white">ข้อมูลสินค้า</label>
          <textarea id="infor" type="textarea" name="p_infor" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-gray-300 rounded-md   dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"><?php echo $row['product_inf.']; ?></textarea>
        </div>
        <div>
        ...
        <div>
          ...
          <input type="text" name="p_price" value="<?php echo $row['product_price/piece']; ?>" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-gray-300 rounded-md   dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
